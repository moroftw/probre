// src/screens/QuickAddDogScreen.tsx
...
export default function QuickAddDogScreen() {
  ...
  // Header custom: back button stilizat + titlu centrat „Add Dog”
  useEffect(() => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      Alert.alert('Error', 'Could not save dog');
    }
  };
